...
import { ArraySignal, IBucketListItem, IBucketListItem2026 } from '@interfaces';
...
export class MainComponent implements OnInit {
    protected readonly svgChat = signal('chat');
    ...
    protected readonly bucketItems2026: ArraySignal<IBucketListItem2026> = BUCKET_LIST_2026.clone();
